...
export class Dashboard2Component implements OnInit {
  ...
  // KPIs
  kpis = [
    { label: 'Proposed Work', value: '232593', icon: 'M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z', colorClass: 'bg-gradient-to-br from-primary-400 to-primary-600', textClass: 'text-primary-600 dark:text-primary-400', cardClass: 'bg-white/70 dark:bg-dark-900/50 backdrop-blur-md border border-slate-200/80 dark:border-dark-800/60 shadow-sm' },
    ...
    { label: 'Financial Sanction', value: '226894', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', colorClass: 'bg-white/20', textClass: 'text-white', cardClass: 'bg-gradient-to-br from-primary-600 via-primary-500 to-accent-600 shadow-glow-primary text-white border border-transparent' },
    { label: 'Utilization Certificate', value: '189156', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', colorClass: 'bg-gradient-to-br from-primary-500 to-primary-700', textClass: 'text-primary-600 dark:text-primary-400', cardClass: 'bg-white/70 dark:bg-dark-900/50 backdrop-blur-md border border-slate-200/80 dark:border-dark-800/60 shadow-sm' },
  ...
  private commonTooltip: any = {
    ...
    borderWidth: 1,
    padding: 14,
    bodyFont: { size: 13, family: "'Poppins', sans-serif", weight: 'normal' },
  ...
  public pieChartOptions: ChartConfiguration['options'] = {
    ...
    plugins: {
      legend: { 
        position: 'right', 
        labels: { color: '#64748b', font: { family: "'Poppins', sans-serif", size: 12 }, usePointStyle: true, padding: 20 }
      },
  ...
  public donutChartOptions: any = {
    ...
    plugins: {
      legend: { 
        position: 'bottom', 
        labels: { color: '#64748b', font: { family: "'Poppins', sans-serif", size: 10 }, usePointStyle: true, padding: 15 }
      },
      tooltip: this.commonTooltip
    }
  };
  ...
  public lineChartOptions: ChartConfiguration['options'] = {
    ...
    scales: {
      x: { 
        grid: { display: false }, 
        ticks: { color: '#94a3b8', font: { family: "'Poppins', sans-serif" }, padding: 10 } 
      },
      y: { 
        border: { display: false, dash: [5, 5] }, 
        grid: { color: 'rgba(148, 163, 184, 0.15)', tickLength: 0 }, 
        ticks: { color: '#94a3b8', font: { family: "'Poppins', sans-serif" }, padding: 15 } 
      }
    },
    plugins: {
